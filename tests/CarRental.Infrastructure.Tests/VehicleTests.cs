...
namespace CarRental.Infrastructure.Tests
{
    public class VehicleTests
    {
        ...
        {   
            ...
            vehicle.Rentals.Add(new Rental(string.Empty, string.Empty, string.Empty, string.Empty, date));
        ...
        public void should_have_equal_numberOfCars()
        {
            ...
            var vehicle = new Vehicle(VehicleType.Car, 100, 100, 4, numberOfVehicles);
