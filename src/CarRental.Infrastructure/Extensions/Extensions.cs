...
namespace CarRental.Infrastructure.Extensions
{
    public static class Extensions
    {
        ...
        {
            context.Vehicles.Add(new Vehicle(VehicleType.DeliveryTruck, 1000, 200, 2, 2));
            context.Vehicles.Add(new Vehicle(VehicleType.Car, 100, 100, 4, 4));
            context.Vehicles.Add(new Vehicle(VehicleType.Limousine, 250, 500, 8, 2));
            context.SaveChanges();
            return context;
        }
